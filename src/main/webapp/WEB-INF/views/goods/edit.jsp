...
<div class="g-doc">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/goods/editSubmit?id=${goods.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
                <label class="fmlab">标题：</label>
                <div class="fmipt">
                    <input type="hidden" name="id" value="${goods.id}"/>
                    <input class="u-ipt ipt" name="title" autofocus placeholder="2-80字符" value="${goods.name}"/>
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">摘要：</label>
                <div class="fmipt">
                    <input class="u-ipt ipt" name="summary" placeholder="2-140字符" value="${goods.summary}"/>
                </div>
            </div>
            <div class="fmitem">
        ...
        <span class="imgpre"><img src="${goods.graphLink}" alt="${goods.graphName}" id="imgpre"></span>
    </div>
</div>
<div class="n-foot">
    <p>前端页面参考自原Demo项目</p>
